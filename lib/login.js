...
export async function login(options) {
  ...
  console.log('');
  console.log(`    peek-api ${parsedUrl.origin} --session ./${path.basename(sessionFile)}`);
  console.log('');
  if (domain.includes('linkedin') || domain.includes('instagram') || domain.includes('facebook')) {
    ...
    console.log('');
    console.log(`    peek-api ${parsedUrl.origin} --session ./${path.basename(sessionFile)} --stealth`);
    console.log('');
  }
